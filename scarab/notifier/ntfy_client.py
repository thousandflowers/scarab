...
class NtfyClient:
    ...
    def notify(self, title: str, message: str, action_url: str = None, priority: str = "default", tags: list = None):
        headers = {
            "Title": title,
            "Priority": priority
        }
        ...
        try:
            response = httpx.post(self.url, data=message.encode("utf-8"), headers=headers, timeout=5.0)
